  ...
  <div v-if="showControlBar">
    <div class="uk-align-right">
      <form @submit.prevent v-if="searchEnabled" role="search" class="uk-search uk-search-default">
        ...
        <input :id="id" type="text" class="uk-search-input uk-width-large" :placeholder="globalSearchPlaceholder"
          :value="value" @input="updateValue($event)" @keyup.enter="entered($event)" />
      </form>
    </div>
