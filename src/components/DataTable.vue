...
import defaultType from '../dataTypes/default';
import ExportButton from './ExportButton.vue';
import DtPagination from './Pagination.vue';
import VgtGlobalSearch from './GlobalSearch.vue';
import VgtTableHeader from './TableHeader.vue';
import VgtHeaderRow from './HeaderRow.vue';
// here we load each data type module.
import * as CoreDataTypes from '../dataTypes/index';
